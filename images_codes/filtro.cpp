...
int main(){
    ...
    unsigned char* imagem = stbi_load("images/piccolo.jpg", &largura, &altura, &canais, 0);
    if(!imagem){
    ...
    stbi_write_png("images/picolo_miope.png", largura, altura, canais, imagem_borrada.data(), 0);
    return 0;
}